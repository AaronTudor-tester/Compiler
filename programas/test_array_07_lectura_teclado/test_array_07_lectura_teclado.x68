...
main:
	; output "=== TEST: Lectura de teclado a array ==="
	LEA str0, A1
	MOVE.B #14, D0	; Task 14 = Display string
	TRAP #15
	; output "\n"
	...
	ADD.L D1, D0
	MOVE.L D0, HEAP_PTR
	; output "Introduce valor para posicion 0:"
	LEA str1, A1
	MOVE.B #14, D0	; Task 14 = Display string
	TRAP #15
	; output "\n"
	...
	MOVE.W D0, t7
	; input t8
	MOVE.B #4, D0	; Task 4 = Read number
	TRAP #15
	MOVE.W D1, t8
	; vector[t7] = t8
	MOVEA.L vector, A0
	...
	MOVE.W t8, D1
	MOVE.L D1, 0(A0, D0.L)
	; output "Introduce valor para posicion 1:"
	LEA str2, A1
	MOVE.B #14, D0	; Task 14 = Display string
	TRAP #15
	; output "\n"
	...
	MOVE.W t12, D1
	MOVE.L D1, 0(A0, D0.L)
	; output "Introduce valor para posicion 2:"
	LEA str3, A1
	MOVE.B #14, D0	; Task 14 = Display string
	TRAP #15
	; output "\n"
	...
	MOVE.W t16, D1
	MOVE.L D1, 0(A0, D0.L)
	; output "Mostrando valores guardados:"
	LEA str4, A1
	MOVE.B #14, D0	; Task 14 = Display string
	TRAP #15
	; output "\n"
...
t9:	DS.W 1
t10:	DS.W 1
str5:	DC.B 'Test completado',0
t12:	DS.W 1
str3:	DC.B 'Introduce valor para posicion 2:',0
t11:	DS.W 1
str4:	DC.B 'Mostrando valores guardados:',0
str1:	DC.B 'Introduce valor para posicion 0:',0
t14:	DS.W 1
str2:	DC.B 'Introduce valor para posicion 1:',0
t13:	DS.W 1
t16:	DS.W 1
t15:	DS.W 1
vector:	DS.L 1
...
t17:	DS.W 1
t19:	DS.W 1
str0:	DC.B '=== TEST: Lectura de teclado a array ===',0
t21:	DS.W 1
t20:	DS.W 1
t23:	DS.W 1
t22:	DS.W 1
