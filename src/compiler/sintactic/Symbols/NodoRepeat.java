...
public class NodoRepeat extends NodoAST {

    private NodoExpresion condicion;
    private NodoBloque cuerpo;

    public NodoRepeat(NodoExpresion cond, NodoBloque cuerpo, int linea, int columna) {
        super(linea, columna);
        this.condicion = cond;
        this.cuerpo = cuerpo;
    }
    ...
    public void imprimirAST(String indent) {
        System.out.println(indent + "NodoRepeat (linea: " + linea + ", col: " + columna + ")");
    ...
    public List<Instruccion> generarCodigo(Generador gen) {
        ...
        codigo.add(new Instruccion("IF", condicion.getTemporal(), null, etiquetaInicio));
    ...
    public void toDot(java.io.PrintWriter out) {
        ...
        buffer.append("\t[label=\"repeat-until\"];");
        buffer.append("\n");
